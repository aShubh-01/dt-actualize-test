      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 xl:px-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-2xl font-bold mb-4">Your Role. Your Impact.</h2>
          ...
          <div className="text-center md:text-left">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-center md:justify-start gap-3">
                <i className="ri-map-pin-fill text-lg" aria-hidden="true"></i>
                <Link
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-400">
            &copy; {new Date().getFullYear()} DeepThought. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
