...
const HeroSection: React.FC<HeroSectionProps> = ({ round }) => {
  ...
  return (
    <section
      className="w-full h-[500px] sm:h-[550px] lg:h-[600px] bg-gradient-to-br from-gray-900 via-gray-800 text-white relative overflow-hidden"
      style={{
        backgroundImage: `linear-gradient(to bottom right, #111827, #1f2937, ${colors.primary[900]})`
      }}
    >
